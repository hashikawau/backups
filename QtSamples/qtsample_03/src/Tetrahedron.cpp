...
//                qWarning() << "Vertex Shader Error" << shader->log();
                std::cout << "Vertex Shader Error" << shader->log().toStdString() << std::endl;
            }
        } else {
//            qWarning() << "Vertex Shader source file " << filepath << "not found.";
            std::cout << "Vertex Shader source file " << filepath.toStdString() << "not found." << std::endl;
        }
    }
    {
        QString filepath("fragment");
...
//                qWarning() << "Fragment Shader Error" << shader->log();
                std::cout << "Fragment Shader Error" << shader->log().toStdString() << std::endl;
            }
        } else {
//            qWarning() << "Fragment Shader source file " << filepath << "not found.";
            std::cout << "Fragment Shader source file " << filepath.toStdString() << "not found." << std::endl;
        }
    }
    if(!m_program->link()){
        qWarning() << "Shader Program Linker Error" << m_program->log();
    }else{
        m_program->bind();
    }
...
void Tetrahedron::draw() {
    ...
    m_program->setAttributeValue("a_color", 1.0f, 1.0f, 1.0f, 1.0f);
