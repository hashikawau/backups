...
#ifndef _base_math_MathTensor
#define _base_math_MathTensor
...
//===========================================================
//===========================================================
class MathTensor1: public MathComponent
{
protected:
    int _length;
    double* _value;
    MathTensor1* _imaginary;
    
public:
    virtual ~MathTensor1();
    MathTensor1();
    MathTensor1(int length);
    MathTensor1(int length, const String& string);
    MathTensor1(const MathTensor1& ref);
    
    double& operator[](int index);
    MathTensor1& operator=(const MathTensor1& ref);
    MathTensor1& operator+=(MathTensor1& ref);
    MathTensor1& operator-=(MathTensor1& ref);
    //MathTensor1& operator*=(MathTensor1& ref);
    //MathTensor1& operator/=(MathTensor1& ref);
    MathTensor1& operator+=(double d);
    MathTensor1& operator-=(double d);
    MathTensor1& operator*=(double d);
    MathTensor1& operator/=(double d);
...
protected:
    ...
    int _ncol;
    double* _value;
    MathTensor2* _imaginary;
    
    MathTensor2(int nrow, int ncol, double* a);
...
{}
MathTensor2::MathTensor2(int numRow, int numColumn):
    _nrow(numRow),
    _ncol(numColumn),
...
MathTensor2::Vector MathTensor2::operator[](int numRow)
{
    if(numRow >= _nrow){
        throw int(0);
    }
...
#endif //ifndef _base_math_MathTensor
