...
#ifndef _base_math_MathTensor2_cpp
#define _base_math_MathTensor2_cpp


//===========================================================
//===========================================================
#include "MathTensor.h"
#include "MathTensor1_cpp.h"
...
//===========================================================
//===========================================================
void MathTensor2::read(ifstream& stream)
{
    if(!stream){
        ...
        if(ch == '\n'){
            if(count){
                if(countrow < _nrow && countcol < _ncol){
                    str[count] = '\0';
                    _value[countrow *_ncol +countcol]
...
void MathTensor2::show(char* delimiter)
{
    cout << "row = " << _nrow << ", ";
    ...
    for(int i=0; i< _nrow; ++i){
        for(int j=0; j< _ncol; ++j){
            cout << _value[i*_ncol +j] << delimiter;
        }
        cout << endl;
    }
    if(_imaginary){
        ...
        for(int i=0; i< _nrow; ++i){
            for(int j=0; j< _ncol; ++j){
                cout << (*_imaginary)._value[i*_ncol +j] << delimiter;
            }
            cout << endl;
        }
    }
...
MathTensor2::MathTensor2():
    ...
    _value(0),
    _imaginary(0){}
MathTensor2::MathTensor2(int nrow, int ncol):
    _nrow(nrow),
    _ncol(ncol),
    _value(new double[nrow *ncol]),
    _imaginary(0)
{}
MathTensor2::MathTensor2(const MathTensor2& ref):
    _nrow(ref._nrow),
    _ncol(ref._ncol),
    _value(new double[ref._nrow *ref._ncol]),
        ...
        0)
{
    int n = _nrow *_ncol;
    for(int i=0; i< n; ++i){
        _value[i] = ref._value[i];
    }
}
//===========================================================
//===========================================================
MathTensor2& MathTensor2::operator=(const MathTensor2& ref)
{
    if(&ref != this){
        _nrow = ref._nrow;
        _ncol = ref._ncol;
...
double* MathTensor2::operator[](int nrow)
{
    if(nrow >= _nrow){
        throw int(0);
    }
...
int MathTensor2::getLength(int rorc)
{
    return rorc <= 0?
        _nrow:
        _ncol;
...
/*
MathTensor1::MathTensor1(int length):
    _length(length),
    _value(new double[length]),
    _imaginary(0){}
MathTensor1::MathTensor1(int length, const String& string):
    _length(length),
    _value(new double[length]),
    _imaginary(0)
{
    ...
    for(int i=0; i< string.length(); ++i){
        if(string[i] == '\n' || ch == ' ' || ch == '\t' || ch == ','){
            if(count){
                str[count] = '\0';
                _value[countrow] = Double::parseDouble(String(str));
                ++countrow;
                if(countrow >= _length){
                    break;
                }
...
MathTensor1::MathTensor1(const MathTensor1& ref):
    _length(ref._length),
    _value(new double[ref._length]),
    _imaginary(0)
{
    ...
    if(ref._imaginary){
        _imaginary = new MathTensor1(*ref._imaginary);
    }
}
//===========================================================
//===========================================================
double& MathTensor1::operator[](int index)
{
    return _value[index];
}
MathTensor1& MathTensor1::operator=(const MathTensor1& ref)
{
    _length = ref._length;
...
MathTensor1& MathTensor1::operator+=(MathTensor1& ref)
{
    if(_length != ref._length){
        throw int(0);
    }
    ...
    if(_imaginary && ref._imaginary){
        for(int i=0; i< _length; ++i){
            (*_imaginary)[i] += (*ref._imaginary)[i];
        }
    }
    return *this;
}
...
MathTensor1& MathTensor1::operator+=(double d)
{
    for(int i=0; i< _length; ++i){
        _value[i] += d;
    }
...
//===========================================================
//===========================================================
const String MathTensor1::toString()
{
    StringBuffer string;
    if(_imaginary){
        string += String("complex vector, length = ");
        string += String(_length);
        string += String("\n");
        for(int i=0; i< _length; ++i){
            string += String(_value[i]);
            string += String(" ");
            string += String((*_imaginary)[i]);
            string += String("\n");
        }
    }else{
        string += String("real vector, length = ");
        string += String(_length);
        string += String("\n");
        for(int i=0; i< _length; ++i){
            string += String(_value[i]);
...
public:
    ...
    MathTensor2(int numRow, int numColumn, double* a);
    void read(ifstream& stream);
    void show(char* delimiter =" \t");
    
public:
    MathTensor2();
    MathTensor2(int numRow, int numColumn);
    ~MathTensor2();
    MathTensor2(const MathTensor2& ref);
    MathTensor2& operator=(const MathTensor2& ref);
    Vector operator[](int numRow);
    ...
    void transpose();
    void inverse();
    void solveeq(MathTensor2& mb);
    double determinant();
    
    MathTensor2 eigenvalue();
    MathTensor2 rank();
};
//===========================================================
//===========================================================
MathTensor2::Vector::Vector(double* a, int numRow):
    _a(a), _nrow(numRow)
{}
MathTensor2::Vector::~Vector(){}
double& MathTensor2::Vector::operator[](int numRow)
{
    if(numRow >= _nrow){
        throw int(0);
    }
...
//===========================================================
//===========================================================
MathTensor2 operator+(MathTensor2& ref1, MathTensor2& ref2)
{
    ...
    return MathTensor2(ref1._nrow, ref2._ncol, a);
}
MathTensor2 operator-(MathTensor2& ref1, MathTensor2& ref2)
{
    if(ref1._nrow != ref2._nrow || ref1._ncol != ref2._ncol){
...
MathTensor2 operator*(double d, MathTensor2& ref)
{
    ...
    return MathTensor2(ref._nrow, ref._ncol, a);
}
MathTensor2 operator*(MathTensor2& ref, double d)
{
    int n = ref._nrow *ref._ncol;
    double* a = new double[n];
    for(int i=0; i< n; ++i){
...
//===========================================================
//===========================================================
MathTensor2::MathTensor2(int numRow, int numColumn, double* a):
    _nrow(numRow), _ncol(numColumn), _a(a)
{}
//===========================================================
//===========================================================
void MathTensor2::copy(int numRow, int numColumn, double* a)
{
    delete [] _a;
    _nrow = numRow;
    _ncol = numColumn;
...
void MathTensor2::solveeq(MathTensor2& mb)
{
    if(_a == 0){
        throw int(0);
    }
...
double MathTensor2::determinant()
{
    if(_a == 0){
        throw int(0);
    }
...
MathTensor2 MathTensor2::eigenvalue()
{
    if(_a == 0){
        throw int(0);
    }
...
//cout << endl;
    ...
    return MathTensor2(_nrow, 2*_nrow, q);
}
//===========================================================
//===========================================================
MathTensor2 MathTensor2::rank()
{
    if(_a == 0){
        throw int(0);
    }
    ...
    return MathTensor2(_nrow, _ncol, q);
}
//===========================================================
//===========================================================
...
void eigenvector(MathTensor2& A, MathTensor2& trans)
{
    MathTensor2 copy =A;
    
    int n = A.getLength(0);
    //MathTensor2 trans(n, n);
    trans = MathTensor2(n, n);
    trans.identity();
...
#endif //ifndef _base_math_MathTensor2_cpp
