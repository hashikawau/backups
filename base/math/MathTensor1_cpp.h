...
#ifndef _base_math_MathTensor1_cpp
#define _base_math_MathTensor1_cpp
...
//===========================================================
//===========================================================
Matrix operator+(Matrix& ref1, Matrix& ref2)
{
...
Matrix operator*(double d, Matrix& ref)
{
...
Matrix operator*(Matrix& ref, double d)
{
    int n = ref._nrow *ref._ncol;
    double* a = new double[n];
    for(int i=0; i< n; ++i){
...
void Matrix::show(char* delimiter)
{
    cout << "row = " << _nrow << ", ";
...
Matrix::Vector Matrix::operator[](int numRow)
{
    if(numRow >= _nrow){
        throw int(0);
    }
...
#endif //ifndef _base_math_MathTensor1_cpp
