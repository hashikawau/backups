...
LRESULT CALLBACK WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    switch(msg)
    {
        ...
        case WM_PAINT:
            ...
            for( int i=0; i< 4; i++ )
            {
                Ellipse( hdc, pos_x[i] -2, pos_y[i] -2, pos_x[i] +2, pos_y[i] +2 );
            }
            MoveToEx( hdc, pos_x[0], pos_y[0], NULL );
            for( int i=1; i< 4; i++ )
            {
                LineTo( hdc, pos_x[i], pos_y[i] );
            }
            ...
            //BitBlt( hdc, x0, y0, 32, 32, hdc_work, 0, 0, SRCCOPY );
            //BitBlt( hdc, x1, y1, 32, 32, hdc_work, 0, 0, SRCCOPY );
            //BitBlt( hdc, x2, y2, 32, 32, hdc_work, 0, 0, SRCCOPY );
            //BitBlt( hdc, x3, y3, 32, 32, hdc_work, 0, 0, SRCCOPY );
